...
public class Debug {
    ...
    public static boolean Driver = K("Driver"),
		NioServerSocketChannel = K("NioServerSocketChannel"),
		ServerBootstrap = K("ServerBootstrap"),
		Channels = K("Channels"),
		StaticChannelPipeline = K("StaticChannelPipeline"),
		
		NioWorker = K("NioWorker"),
		NioServerSocketPipelineSink = K("NioServerSocketPipelineSink"),
		OioClientSocketPipelineSink = K("OioClientSocketPipelineSink"),


		AbstractChannel = K("AbstractChannel"),
		SimpleChannelUpstreamHandler = K("SimpleChannelUpstreamHandler"),
		DefaultChannelPipeline = K("DefaultChannelPipeline"),

		OioWorker = K("OioWorker"),
		DefaultChannelFuture = K("DefaultChannelFuture"),
		...
		ReplayingDecoder = K("ReplayingDecoder");
