...
public class DefaultChannelFuture implements ChannelFuture {
	private static my.Debug DEBUG=new my.Debug(my.Debug.DefaultChannelFuture);//我加上的
	...
	public String toString() {
		return "DefaultChannelFuture[waiters="+waiters+", isDone="+isDone()+", isSuccess="+isSuccess()+", isCancelled="+isCancelled()+", cause="+cause+"]";
	}
    ...
    public boolean setSuccess() {
		...
		DEBUG.P("firstListener="+firstListener);

        notifyListeners();
        return true;

		}finally{//我加上的
		DEBUG.P(0,this,"setSuccess()");
		}
    }
