...
public class SimpleChannelUpstreamHandler implements ChannelUpstreamHandler {
	private static my.Debug DEBUG=new my.Debug(my.Debug.SimpleChannelUpstreamHandler);//我加上的
    ...
    public void handleUpstream(
        ...
        if (e instanceof MessageEvent) {
			...
			//ChildChannelStateEvent是没有getState()的，并不像ChannelStateEvent类，
			//这个“ChildChannelState”名字起得不好
            ...
            ctx.sendUpstream(e); //转给下一个ChannelHandler
        }

		}finally{//我加上的
		DEBUG.P(0,this,"handleUpstream(2)");
		}
    }


	//因为一个ChannelHandlerContext与一个ChannelHandler对应，
	//所以下面的所有ctx.sendUpstream(e)调用相当于把当前的ChannelEvent转
