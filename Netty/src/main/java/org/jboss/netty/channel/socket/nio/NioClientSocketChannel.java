 ...
 *
 */
//NioClientSocketChannel这个是代表客户端连到服务器端的通道
//NioAcceptedSocketChannel是服务器端在调用accept方法时返回的通道
//NioClientSocketChannel没有父通道(Parent Channel)
//NioAcceptedSocketChannel有父通道(就是对应服务器的主通道)
