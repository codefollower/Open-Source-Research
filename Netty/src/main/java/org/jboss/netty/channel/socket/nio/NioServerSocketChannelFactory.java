...
public class NioServerSocketChannelFactory implements ServerSocketChannelFactory {
    ...
    public NioServerSocketChannelFactory(
		...
		//SelectorUtil.DEFAULT_IO_THREADS默认是cpu个数的两倍
    ...
    public NioServerSocketChannelFactory(
            ...
            int workerCount) {
		try {//我加上的
		DEBUG.P(this,"NioServerSocketChannelFactory(3)");
		...
		DEBUG.P(0,this,"NioServerSocketChannelFactory(3)");
		}
    }
    ...
    public void releaseExternalResources() {
		try {//我加上的
		DEBUG.P(this,"releaseExternalResources()");

        ExecutorUtil.terminate(bossExecutor, workerExecutor);

		}finally{//我加上的
		DEBUG.P(0,this,"releaseExternalResources()");
		}
    }
}
