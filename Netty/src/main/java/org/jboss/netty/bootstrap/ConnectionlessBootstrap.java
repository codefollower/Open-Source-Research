...
//三个connect方法与ClientBootstrap一样，用于Client端
//虽然说ConnectionlessBootstrap只用于Datagram这种无链接的情况，
//实际上ConnectionlessBootstrap可以替换ClientBootstrap
public class ConnectionlessBootstrap extends Bootstrap {
     ...
     *            failed to create a new {@link ChannelPipeline}
     */
	//这个方法与ClientBootstrap一样，用于Client端
