...
public class ClientBootstrap extends Bootstrap {
    ...
    public ChannelFuture connect() {
		//SocketAddress类只有一个子类InetSocketAddress，
		//InetSocketAddress如果用在Server端，只要调用new InetSocketAddress(port)，
		//InetSocketAddress如果用在Client端，要提供ip和port
    ...
    public ChannelFuture connect(final SocketAddress remoteAddress, final SocketAddress localAddress) {
        ...
        try {
			//如果没有调用setPipelineFactory而是使用默认的ChannelPipelineFactory，
			//那么在下面的Channel ch = getFactory().newChannel(pipeline);
