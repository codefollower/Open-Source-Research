 ...
 */
@Version("@(#)Source.java	1.47 07/03/21")
public enum Source {
	...
	if (instance == null) {
		DEBUG.P(Source.class,"instance(1)");
	    ...
	    DEBUG.P("options.get(\"-source\")="+sourceString);
	    DEBUG.P("source="+instance);
	    DEBUG.P(1,Source.class,"instance(1)");
	}
	return instance;
    }
