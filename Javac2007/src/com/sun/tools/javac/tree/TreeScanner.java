/*
 * @(#)TreeScanner.java	1.28 07/03/21
 * 
...
public class TreeScanner extends Visitor {
    ...
    public void scan(JCTree tree) {
		DEBUG.P(this,"scan(JCTree tree)");
		if(tree!=null) DEBUG.P("tree.tag="+tree.myTreeTag());
		else DEBUG.P("tree=null");
		
		if(tree!=null) tree.accept(this);
		
		DEBUG.P(0,this,"scan(JCTree tree)");
    }

    /** Visitor method: scan a list of nodes.
     */
    public void scan(List<? extends JCTree> trees) {
		DEBUG.P(this,"scan(List<? extends JCTree> trees)");
		...
		DEBUG.P(0,this,"scan(List<? extends JCTree> trees)");
    }
