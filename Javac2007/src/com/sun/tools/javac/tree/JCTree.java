...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    private static my.Debug DEBUG=new my.Debug(my.Debug.JCTree);//我加上的
    
    //JCTree没有实现接口Tree的getKind()方法，该方法由JCTree的子类实现
    ...
    //两个myTreeTag()方法是我加上的，调试用途
    public String myTreeTag() {
    	return myTreeTag(this.tag);
    }
    public String myTreeTag(int tag) {
        switch (tag) {
        case TOPLEVEL:
            return "TOPLEVEL visitTopLevel";
        case IMPORT:
            return "IMPORT visitImport";
        case CLASSDEF:
            return "CLASSDEF visitClassDef";
        case METHODDEF:
            return "METHODDEF visitMethodDef";
       case VARDEF:
            return "VARDEF visitVarDef";
        case SKIP:
            return "SKIP visitSkip";
        case BLOCK:
            return "BLOCK visitBlock";
        case DOLOOP:
            return "DOLOOP visitDoLoop";
            
        case WHILELOOP:
            return "WHILELOOP visitWhileLoop";
        case FORLOOP:
            return "FORLOOP visitForLoop";
        case FOREACHLOOP:
            return "FOREACHLOOP visitForeachLoop";
        case LABELLED:
            return "LABELLED visitLabelled"; 
        case SWITCH:
            return "SWITCH visitSwitch";
        case CASE:
            return "CASE visitCase";
        case SYNCHRONIZED:
            return "SYNCHRONIZED visitSynchronized";
        case TRY:
            return "TRY visitTry";
        case CATCH:
            return "CATCH visitCatch";
        case CONDEXPR:
            return "CONDEXPR visitConditional";
        case IF:
            return "IF visitIf"; 
        case EXEC:
            return "EXEC visitExec";
        case BREAK:
            return "BREAK visitBreak";
        case CONTINUE:
            return "CONTINUE visitContinue";
        case RETURN:
            return "RETURN visitReturn"; 
            
        case THROW:
            return "THROW visitThrow"; 
        case ASSERT:
            return "ASSERT visitAssert";
        case APPLY:
            return "APPLY visitApply";
        case NEWCLASS:
            return "NEWCLASS visitNewClass"; 
        case NEWARRAY:
            return "NEWARRAY visitNewArray";
        case PARENS:
            return "PARENS visitParens";
        case ASSIGN:
            return "ASSIGN visitAssign"; 
        case TYPECAST:
            return "TYPECAST visitTypeCast";
        case TYPETEST:
            return "TYPETEST visitTypeTest";
        case INDEXED:
            return "INDEXED visitIndexed"; 
        case SELECT:
            return "SELECT visitSelect";
            
        case IDENT:
            return "IDENT visitIdent";
        case LITERAL:
            return "LITERAL visitLiteral";
        case TYPEIDENT:
            return "TYPEIDENT visitTypeIdent";
        case TYPEARRAY:
            return "TYPEARRAY visitTypeArray";
        case TYPEAPPLY:
            return "TYPEAPPLY visitTypeApply";
        case TYPEPARAMETER:
            return "TYPEPARAMETER visitTypeParameter";
        case WILDCARD:
            return "WILDCARD visitWildcard";
        case TYPEBOUNDKIND:
            return "TYPEBOUNDKIND visitTypeBoundKind";
        case ANNOTATION:
            return "ANNOTATION visitAnnotation";
        case MODIFIERS:
            return "MODIFIERS visitModifiers";
        case ERRONEOUS:
            return "ERRONEOUS visitErroneous";
        case LETEXPR:
            return "LETEXPR visitLetExpr";
        default:
            return myTreeTag2(tag);
        }
    }
    private String myTreeTag2(int tag) {
        switch (tag) {
        // Postfix expressions
        case JCTree.POSTINC:           // _ ++
            return "POSTINC visitUnary";
        case JCTree.POSTDEC:           // _ --
            return "POSTDEC visitUnary";

        // Unary operators
        case JCTree.PREINC:            // ++ _
            return "PREINC visitUnary";
        case JCTree.PREDEC:            // -- _
            return "PREDEC visitUnary";
        case JCTree.POS:               // +
            return "POS visitUnary";
        case JCTree.NEG:               // -
            return "NEG visitUnary";
        case JCTree.COMPL:             // ~
            return "COMPL visitUnary";
        case JCTree.NOT:               // !
            return "NOT visitUnary";
    ...
    public static class JCImport extends JCTree implements ImportTree {
        ...
        public void accept(Visitor v) { 
        	//my.L.o(this,"accept(1)");
        	//my.L.o("Visitor v.getClass().getName()="+v.getClass().getName());
        	v.visitImport(this); 
        	//my.L.o(1,this,"accept(1)");
        }

        public boolean isStatic() { return staticImport; }
        public JCTree getQualifiedIdentifier() { return qualid; }
        
        //Kind是在接口com.sun.source.tree.Tree中定义
    ...
    public static class JCEnhancedForLoop extends JCStatement implements EnhancedForLoopTree {
        //例子:for ( JCVariableDecl var : expr ) { body }
    ...
    public static class JCArrayAccess extends JCExpression implements ArrayAccessTree {
        public JCExpression indexed;//数组名
        public JCExpression index;//索引号
