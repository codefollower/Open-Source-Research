...
public class CRTable implements CRTFlags {
	private static my.Debug DEBUG=new my.Debug(my.Debug.CRTable);//我加上的
    ...
    public CRTable(JCTree.JCMethodDecl tree, Map<JCTree, Integer> endPositions) {
		DEBUG.P(this,"CRTable(2)");
		this.methodTree = tree;
		this.endPositions = endPositions;
		DEBUG.P(0,this,"CRTable(2)");
    }
    ...
    public void put(Object tree, int flags, int startPc, int endPc) {
    	DEBUG.P(this,"put(4)");
		DEBUG.P("startPc="+startPc+" endPc="+endPc);
		DEBUG.P("flags="+getTypes(flags));
		DEBUG.P("tree="+tree);

        entries.append(new CRTEntry(tree, flags, startPc, endPc));
        
        DEBUG.P(0,this,"put(4)");
    }
    ...
    public String getTypes(int flags) {//我加上的,方便调试
		String types = "";
    ...
    static class SourceRange {
		 ...
		 */
		//扩大startPos到endPos的范围
		//例如:      SourceRange A(startPos=10,endPos=1000);
		//           SourceRange B(startPos=70,endPos=9000);
		//A，B合并为:SourceRange C(startPos=10,endPos=9000);
		//也就是startPos取两者中最小，endPos取两者中最大
		//(startPos与endPos为Position.NOPOS取SourceRange sr的对应值)
