 ...
 */
@Version("@(#)Messages.java	1.5 07/03/21")
public class Messages {
     ...
     */
    //当以后要获取本地化字符串时，总是从最近加进来的ResourceBundle中开始查找
	...
	//指的是com.sun.tools.javac.util.JCDiagnostic
    ...
    private static String getLocalizedString(List<ResourceBundle> bundles,
		...
		//把msg中的{0},{1},{2}......替换成数组args对应下标的元素
		//msg中的{0},{1},{2}......不用按数字大小排列，还可以重复。
		//如MessageFormat.format("参数{0},参数{0},参数{1},参数{3},参数{2}",1,2,3,4)
		//格式化后的字符串为"参数1,参数1,参数2,参数4,参数3"
