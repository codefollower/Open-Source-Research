 ...
 */
@Version("@(#)JavacFiler.java	1.16 07/03/21")
public class JavacFiler implements Filer, Closeable {
    ...
    JavacFiler(Context context) {
        ...
        //在java.util.Collections定义synchronizedSet与synchronizedMap方法
        //是?态导入的
    ...
    public String toString() {
        return "javac Filer version @(#)JavacFiler.java	1.16 07/03/21";
    }
