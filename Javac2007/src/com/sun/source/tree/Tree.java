...
public interface Tree {
	...
	//complement中文翻译是指“反码”
	//bitwise complement operator 是指“按位取反运算符”
        /**
	...
	//logical complement operator 是指“boolean逻辑反运算符”
	//!true=false,!false=true，不能用于非boolean类型
        /**
         ...
         * right shift {@code >>}.
         */
        RIGHT_SHIFT(BinaryTree.class),//左边用符号位往右移

        /**
         * Used for instances of {@link BinaryTree} representing
         * unsigned right shift {@code >>>}.
         */
        UNSIGNED_RIGHT_SHIFT(BinaryTree.class),//左边用0往右移
