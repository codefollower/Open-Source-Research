	...
	for (List<? extends JCTree> l = trees; l.nonEmpty(); l = l.tail)
	    validate(l.head);
	DEBUG.P(0,this,"validate(List<? extends JCTree> trees)");
    }
    ...
    DEBUG.P(this,"checkClassBounds(DiagnosticPosition pos, Type type)");
    DEBUG.P("type="+type);
	checkClassBounds(pos, new HashMap<TypeSymbol,Type>(), type);
	DEBUG.P(2,this,"checkClassBounds(DiagnosticPosition pos, Type type)");
    }
//where
