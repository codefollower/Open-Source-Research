...
public class LogManager
{
    ...
    {
		try {//我加上的
		DEBUG.P(LogManager.class,"createLogChute(1)");
		DEBUG.P("RuntimeConstants.RUNTIME_LOG_LOGSYSTEM="+RuntimeConstants.RUNTIME_LOG_LOGSYSTEM);
        ...
        for( Iterator ii = classes.iterator(); ii.hasNext(); )
        {
            ...
            if (claz != null && claz.length() > 0 )
            {
                ...
                try
                {
					...
					DEBUG.P("(o instanceof LogChute)="+(o instanceof LogChute));
					DEBUG.P("(o instanceof LogSystem)="+(o instanceof LogSystem));
		...
		DEBUG.P(0,LogManager.class,"createLogChute(1)");
		}
    }
    ...
    {
		try {//我加上的
		DEBUG.P(LogManager.class,"isProbablyProvidedLogChute(1)");
		DEBUG.P("claz="+claz);
		...
		DEBUG.P(0,LogManager.class,"isProbablyProvidedLogChute(1)");
		}
    }
    ...
    {
		try {//我加上的
		DEBUG.P(LogManager.class,"updateLog(2)");
		...
		DEBUG.P(0,LogManager.class,"updateLog(2)");
		}
    }
