...
public class VelocimacroFactory
{
     ...
     */
	//定义宏的文件名列表，如:velocimacro.library = myvm1.vm,myvm2.vm
     ...
     */
	//Map<String, Twonk>
	//key是定义宏的文件名，Twonk包含定义宏的文件名在解析后的Template和文件修改时间
    ...
    public VelocimacroFactory(final RuntimeServices rsvc)
    {
		...
		DEBUG.P(0,this,"VelocimacroFactory(1)");
		}
    }
    ...
    public void initVelocimacro()
    {
        ...
        synchronized(this)
        {
             ...
             */
             ...
             if (libfiles == null)
             {
				 ...
				 //尝试在file.resource.loader.path(取决于resource.loader的值)
				 //中查找VM_global_library.vm
             ...
             if(libfiles != null)
             {
				 ...
				 DEBUG.P("macroLibVec="+macroLibVec);
		...
		DEBUG.P(0,this,"initVelocimacro()");
		}
    }
     ...
     */
	//这个方法与下面的addVelocimacro类似，
	//但是macroBody是字符串类型，要先用parser解析一次得到一个Node，
	//这个方法在RuntimeInstance中是不推荐使用的。
    public boolean addVelocimacro(String name, String macroBody,
            String argArray[], String sourceTemplate)
    {
		try {//我加上的
		DEBUG.P(this,"addVelocimacro(4)");
		//DEBUG.e();
		...
		DEBUG.P(0,this,"addVelocimacro(4)");
		}
    }
     ...
     */
	//在Parser.parse阶段调用
	//name是宏名，argArray第0项也是宏名，其他是变量名(不包含$)
	//macroBody是宏体，是org.apache.velocity.runtime.parser.node.ASTBlock类型
	//sourceTemplate是定义宏的文件
    public boolean addVelocimacro(String name, Node macroBody,
            String argArray[], String sourceTemplate)
    {
		try {//我加上的
		DEBUG.P(this,"addVelocimacro(4.1)");
		//DEBUG.e();
		/*
		java.lang.Error
			at my.Debug.e(Debug.java:247)
			at org.apache.velocity.runtime.VelocimacroFactory.addVelocimacro(VelocimacroFactory.java:451)
			at org.apache.velocity.runtime.RuntimeInstance.addVelocimacro(RuntimeInstance.java:1733)
			at org.apache.velocity.runtime.directive.Macro.processAndRegister(Macro.java:178)
			at org.apache.velocity.runtime.parser.Parser.Directive(Parser.java:922)
			...
			at org.apache.velocity.runtime.RuntimeInstance.parse(RuntimeInstance.java:1241)
			at org.apache.velocity.runtime.RuntimeInstance.parse(RuntimeInstance.java:1191)
			at org.apache.velocity.Template.process(Template.java:138)
			at org.apache.velocity.runtime.resource.ResourceManagerImpl.loadResource(ResourceManagerImpl.java:501)
			at org.apache.velocity.runtime.resource.ResourceManagerImpl.getResource(ResourceManagerImpl.java:400)
			at org.apache.velocity.runtime.RuntimeInstance.getTemplate(RuntimeInstance.java:1519)
			at org.apache.velocity.runtime.RuntimeSingleton.getTemplate(RuntimeSingleton.java:326)
			at org.apache.velocity.app.Velocity.getTemplate(Velocity.java:425)
			at test.Test.<init>(Test.java:81)
		...
		*/
		...
		DEBUG.P(0,this,"addVelocimacro(4.1)");
		}
    }
     ...
     */
     ...
     public Directive getVelocimacro(String vmName, String sourceTemplate, String renderingTemplate)
     {
		...
		DEBUG.P(0,this,"getVelocimacro(3)");
		}
    }
