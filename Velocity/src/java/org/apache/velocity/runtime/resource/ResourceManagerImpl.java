    ...
    implements ResourceManager
{
    ...
    {
		try {//我加上的
		DEBUG.P(this,"initialize(1)");

		DEBUG.P("isInit="+isInit);
        if (isInit)
        {
		...
		DEBUG.P("logWhenFound="+logWhenFound);
		DEBUG.P("cacheClassName="+cacheClassName);
    ...
    {
		try {//我加上的
		DEBUG.P(this,"assembleResourceLoaderInitializers()");
		...
		DEBUG.P("resourceLoaderNames="+resourceLoaderNames);
		...
		DEBUG.P(0,this,"assembleResourceLoaderInitializers");
		}
    }
    ...
    {
		try {//我加上的
		DEBUG.P(this,"getResource(3)");
		DEBUG.P("resourceName="+resourceName);
		DEBUG.P("resourceType="+resourceType);
		...
		DEBUG.P("resourceKey="+resourceKey);
