...
public class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {
        ...
        throws ParseException
    {
		...
		//DEBUG.P("directives="+directives); //已经有值了
    ...
    {
		try {//我加上的
		DEBUG.P(this,"escapedDirective(1)");
		DEBUG.P("strImage="+strImage);
		...
		DEBUG.P(0,this,"escapedDirective(1)");
		}
    }
 ...
 */
  ...
  DEBUG.P("jjtn000.fisrt="+jjtn000.getFirstToken());
  DEBUG.P("jjtn000.parser.getToken(0)="+getToken(0));
  DEBUG.P("jjtn000.parser.getToken(1)="+getToken(1));

  DEBUG.P("jj_ntk="+jj_ntk);
 ...
 */
  ...
  DEBUG.P("Escape() jjtn000="+jjtn000);
 ...
 * ----------------------------------------------------------------------*/
  ...
  private int jj_la;
  public boolean lookingAhead = false; //lookingAhead总是false
