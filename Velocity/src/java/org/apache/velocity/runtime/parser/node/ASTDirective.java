...
public class ASTDirective extends SimpleNode
{
    ...
    throws TemplateInitException
    {
        ...
        if (!isInitialized)
        {
			...
			//在Parser中会事无调用setDirectiveName
			DEBUG.P("directiveName="+directiveName);
        ...
        throws IOException,MethodInvocationException, ResourceNotFoundException, ParseErrorException
    {
		...
		DEBUG.P("isDirective="+isDirective);
		DEBUG.P("directiveName="+directiveName);
		DEBUG.P("directive="+directive);
    ...
    {
		try {//我加上的
		DEBUG.P(this,"setDirectiveName(1)");
		DEBUG.P("str="+str);
		//DEBUG.e(); //在org.apache.velocity.runtime.parser.Parser.Directive中执行

        directiveName = str;

		}finally{//我加上的
		DEBUG.P(0,this,"setDirectiveName(1)");
		}
    }
