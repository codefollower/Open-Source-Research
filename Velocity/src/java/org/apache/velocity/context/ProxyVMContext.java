...
public class ProxyVMContext extends ChainedInternalContextAdapter
{
    ...
    {
		try {//我加上的
		DEBUG.P(this,"addVMProxyArg(4)");
		DEBUG.P("macroArgumentName="+macroArgumentName); //相当于形参
		DEBUG.P("literalMacroArgumentName="+literalMacroArgumentName); //相当于形参的别名
		DEBUG.P("argumentValue="+argumentValue); //相当于实参

		DEBUG.P("isConstant(argumentValue)="+isConstant(argumentValue)); //相当于实参
		/*
		macroArgumentName=color
		literalMacroArgumentName=.literal.$color
		argumentValue=org.apache.velocity.runtime.parser.node.ASTReference@84abc9[id=16,info=0,invalid=false,children=0,tokens=[$color]]
		isConstant(argumentValue)=false
		*/
		...
		DEBUG.P(0,this,"addVMProxyArg(4)");
		}
    }
