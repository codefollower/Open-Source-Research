...
class JSSESupport implements com.codefollower.douyu.http.ssl.SSLSupport, com.codefollower.douyu.http.ssl.SSLSessionManager {
    
	private static final InternalLogger log = InternalLoggerFactory.getInstance(JSSESupport.class);
    ...
    public Integer getKeySize() 
        throws IOException {
        // Look up the current SSLSession
        com.codefollower.douyu.http.ssl.SSLSupport.CipherData c_aux[]=ciphers;
        if (session == null)
            return null;
