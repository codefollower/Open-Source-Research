...
import com.codefollower.douyu.netty.util.internal.ThreadLocalBoolean;
...
class NioAcceptedSocketChannel extends AbstractChannel {
    ...
    private final NioAcceptedSocketChannelConfig config;
    ...
    NioAcceptedSocketChannel(
        ...
        this.socket = socket;
        this.worker = worker;
        config = new NioAcceptedSocketChannelConfig(socket.socket());
    ...
    @Override
    public NioAcceptedSocketChannelConfig getConfig() {
        return config;
    }
            ...
            if (newWriteBufferSize >= highWaterMark) {
                if (newWriteBufferSize - messageSize < highWaterMark) {
                    ...
                    if (!notifying.get()) {
                        ...
                        fireChannelInterestChanged(NioAcceptedSocketChannel.this);
    ...
    private final class WriteTask implements Runnable {
        ...
        public void run() {
            ...
            worker.writeFromTaskLoop(NioAcceptedSocketChannel.this);
        }
    }
}
