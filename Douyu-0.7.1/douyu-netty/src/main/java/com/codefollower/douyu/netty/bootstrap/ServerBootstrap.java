 ...
 * under the License.
 */
package com.codefollower.douyu.netty.bootstrap;
...
import com.codefollower.douyu.netty.channel.ChannelConfig;
...
import com.codefollower.douyu.netty.channel.ChildChannelStateEvent;
...
public class ServerBootstrap extends Bootstrap {
    ...
    public void setFactory(ChannelFactory factory) {
        ...
        if (!(factory instanceof NioServerSocketChannelFactory)) {
            throw new IllegalArgumentException(
                    "factory must be a " +
                    NioServerSocketChannelFactory.class.getSimpleName() + ": " +
                    factory.getClass());
        }
