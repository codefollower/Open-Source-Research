...
import com.codefollower.douyu.netty.channel.DefaultServerChannelConfig;
 ...
 * @version $Rev$, $Date$
 */
public class NioServerSocketChannelConfig extends DefaultServerChannelConfig {
     ...
     */
    public NioServerSocketChannelConfig(ServerSocket socket) {
        if (socket == null) {
