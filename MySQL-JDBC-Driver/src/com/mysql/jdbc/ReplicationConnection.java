...
public class ReplicationConnection implements Connection, PingTarget {
	private static my.Debug DEBUG=new my.Debug(my.Debug.ReplicationConnection);//我加上的
	...
	public ReplicationConnection(Properties masterProperties,
		...
		try {//我加上的
		DEBUG.P(this,"ReplicationConnection(2)");
		DEBUG.P("masterProperties="+masterProperties);
		DEBUG.P("slaveProperties="+slaveProperties);
		...
		DEBUG.P("masterConnection="+masterConnection);
		DEBUG.P("slavesConnection="+slavesConnection);

		}finally{//我加上的
		DEBUG.P(0,this,"ReplicationConnection(2)");
		}
	}
