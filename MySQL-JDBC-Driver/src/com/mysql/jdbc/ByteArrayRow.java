...
public class ByteArrayRow extends ResultSetRow {
	private static my.Debug DEBUG = new my.Debug(my.Debug.ResultSetImpl);//我加上的
	...
	public ByteArrayRow(byte[][] internalRowData, ExceptionInterceptor exceptionInterceptor) {
		...
		for(byte[] fieldData : internalRowData) {
			if(fieldData != null)
				DEBUG.P("fieldData="+new String(fieldData));
			else
				DEBUG.P("fieldData=null");
		}

		//DEBUG.PA("internalRowData",internalRowData);
