...
public class ResultSetMetaData implements java.sql.ResultSetMetaData {
	private static my.Debug DEBUG=new my.Debug(my.Debug.ResultSetMetaData);//我加上的
	...
	public ResultSetMetaData(Field[] fields, boolean useOldAliasBehavior, ExceptionInterceptor exceptionInterceptor) {
		try {//我加上的
		DEBUG.P(this,"ResultSetMetaData(3)");
		//useOldAliasMetadataBehavior属性默认是false
		//如果把useOldAliasMetadataBehavior属性设为true，
		//那么当要获得列名和表名时，就会使用as右边的名称，
		//如"select name, age as a from pet as b"，
		//当rsmd.getColumnName(2)时返回a,rsmd.getTableName(1)时返回b
		DEBUG.P("useOldAliasBehavior="+useOldAliasBehavior);
		...
		DEBUG.P(0,this,"ResultSetMetaData(3)");
		}
	}
	...
	static String getClassNameForJavaType(int javaType, 
		...
		case Types.BIGINT:
			//不是无符号数(相当于有符号数)，有符号数能表示的范围(>0)比无符号数小
			//所以这里用long
			if (!isUnsigned) {
				return "java.lang.Long"; //$NON-NLS-1$
			}
	...
	public boolean isWrapperFor(Class iface) throws SQLException {
		...
		//如果iface=Class.forName("com.mysql.jdbc.ResultSetMetaData");
		//相当于 "this instanceof com.mysql.jdbc.ResultSetMetaData"
	...
	public Object unwrap(Class iface) throws java.sql.SQLException {
    	try {
			...
			//如果iface=Class.forName("com.mysql.jdbc.ResultSetMetaData");
			//相当于强制转换操作: "(com.mysql.jdbc.ResultSetMetaData)this"
