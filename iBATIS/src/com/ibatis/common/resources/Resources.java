...
public class Resources extends Object {
    private static my.Debug DEBUG = new my.Debug(my.Debug.Resources);//�Ҽ��ϵ�
    ...
    public static Reader getResourceAsReader(String resource) throws IOException {
        DEBUG.P(Resources.class, "getResourceAsReader(1)");
        DEBUG.P("resource=" + resource);
        DEBUG.P("charset=" + charset);
        ...
        DEBUG.P(0, Resources.class, "getResourceAsReader(1)");
        return reader;
    }
