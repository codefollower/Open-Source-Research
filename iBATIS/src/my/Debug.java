...
public class Debug {
    ...
    //对应的类文件是否输出调试信息
    public static boolean Resources = K("Resources"), SqlMapConfigParser = K("SqlMapConfigParser"),
            NodeletParser = K("NodeletParser"), SqlMapExecutorDelegate = K("SqlMapExecutorDelegate"),
            MappedStatement = K("MappedStatement");
