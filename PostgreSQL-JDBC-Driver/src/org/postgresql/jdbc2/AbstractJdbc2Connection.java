...
{
	private static my.Debug DEBUG=new my.Debug(my.Debug.AbstractJdbc2Connection);//我加上的
    ...
    protected int prepareThreshold; //在构造函数中默认设为5
    ...
    {
		try {//我加上的
		DEBUG.P(this,"AbstractJdbc2Connection(6)");
		DEBUG.P("host="+host);
		DEBUG.P("port="+port);
		DEBUG.P("user="+user);
        ...
        try
        {
			...
			DEBUG.P("prepareThreshold="+prepareThreshold);
		...
		DEBUG.P("dbVersionNumber="+dbVersionNumber);
        if (logger.logDebug())
        {
        ...
        DEBUG.P("bindStringAsVarchar="+bindStringAsVarchar);
		DEBUG.P("unknownLength="+unknownLength);
		...
		DEBUG.P(0,this,"AbstractJdbc2Connection(6)");
		}
    }
    ...
    {
		try {//我加上的
		DEBUG.P(this,"setAutoCommit(1)");
		DEBUG.P("autoCommit="+autoCommit);
		DEBUG.P("this.autoCommit="+this.autoCommit);
		...
		DEBUG.P(0,this,"setAutoCommit(1)");
		}
    }
    ...
    private void executeTransactionCommand(Query query) throws SQLException {
		try {//我加上的
		DEBUG.P(this,"executeTransactionCommand(1)");
		DEBUG.P("query="+query);
		...
		DEBUG.P(0,this,"executeTransactionCommand(1)");
		}
    }
