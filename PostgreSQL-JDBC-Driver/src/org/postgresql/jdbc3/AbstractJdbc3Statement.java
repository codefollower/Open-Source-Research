...
public abstract class AbstractJdbc3Statement extends org.postgresql.jdbc2.AbstractJdbc2Statement
{
    ...
    //加上"RETURNING 字段列表"或"RETURNING *"
	//如:
	//insert into weather(city,temp_lo) values('aa',10) RETURNING "city", "temp_lo"
	//insert into weather(city,temp_lo) values('aa',10) RETURNING *
