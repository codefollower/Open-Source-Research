...
*
* IDENTIFICATION
*   $PostgreSQL: pgjdbc/org/postgresql/fastpath/Fastpath.java,v 1.36 2010/03/21 07:13:37 jurka Exp $
*
*-------------------------------------------------------------------------
*/
...
{
	private static my.Debug DEBUG=new my.Debug(my.Debug.Fastpath);//我加上的
    ...
    {
		try {//我加上的
		DEBUG.P(this,"addFunctions(1)");

        while (rs.next())
        {
			DEBUG.P("rs.getString(1)="+rs.getString(1));
			DEBUG.P("rs.getInt(2)="+rs.getInt(2));

            func.put(rs.getString(1), new Integer(rs.getInt(2)));
        }

		}finally{//我加上的
		DEBUG.P(0,this,"addFunctions(1)");
		}
    }
