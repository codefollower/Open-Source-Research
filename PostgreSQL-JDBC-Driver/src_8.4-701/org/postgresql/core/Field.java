...
public class Field
{
	...
	public String toString() {
		return "Field[columnLabel="+columnLabel+",columnName="+columnName+",oid="+oid+",length="+length+",mod="+mod+",tableOid="+tableOid+",positionInTable="+positionInTable+",format="+format+"]";
	}
