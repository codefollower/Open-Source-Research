...
*
* IDENTIFICATION
*   $PostgreSQL: pgjdbc/org/postgresql/jdbc3/AbstractJdbc3Connection.java,v 1.20 2009/07/01 01:29:38 jurka Exp $
*
*-------------------------------------------------------------------------
*/
...
public abstract class AbstractJdbc3Connection extends org.postgresql.jdbc2.AbstractJdbc2Connection
{
    ...
    {
		//加上"RETURNING *"
		//如: insert into weather(city,temp_lo) values('aa',10) RETURNING *
    ...
    {
		//加上"RETURNING 字段列表"
		//如: insert into weather(city,temp_lo) values('aa',10) RETURNING "city", "temp_lo"
