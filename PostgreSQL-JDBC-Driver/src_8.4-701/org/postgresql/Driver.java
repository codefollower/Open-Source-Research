...
public class Driver implements java.sql.Driver
{
    ...
    static
    {
		if(my.Debug.Driver) {
			...
			DriverManager.setLogWriter(new PrintWriter(System.out, true));//我加上的
		}
    ...
    {
        return "PostgreSQL 8.4 JDBC3g (build " + PSQLDriverVersion.buildNumber + ")";
    }
