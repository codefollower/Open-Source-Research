...
public class RunNotifier {
	...
	public void addListener(RunListener listener) {
		DEBUG.P(this,"addListener(1)");
		DEBUG.P("listener="+listener);

		fListeners.add(listener);

		DEBUG.P("fListeners.size="+fListeners.size());

		DEBUG.P(0,this,"addListener(1)");
	}
	...
	public void fireTestRunStarted(final Description description) {
		DEBUG.P(this,"fireTestRunStarted(1)");
		...
		DEBUG.P(0,this,"fireTestRunStarted(1)");
	}
	...
	public void fireTestRunFinished(final Result result) {
		DEBUG.P(this,"fireTestRunFinished(1)");
		...
		DEBUG.P(0,this,"fireTestRunFinished(1)");
	}
	...
	public void addFirstListener(RunListener listener) {
		DEBUG.P(this,"addFirstListener(1)");
		DEBUG.P("listener="+listener);

		fListeners.add(0, listener);

		DEBUG.P("fListeners.size="+fListeners.size());
		DEBUG.P(0,this,"addFirstListener(1)");
	}
