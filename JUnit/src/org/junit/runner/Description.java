...
public class Description {
	...
	public static Description createSuiteDescription(String name, Annotation... annotations) {
		try {//我加上的
		DEBUG.P(Description.class,"createSuiteDescription(2)");
		DEBUG.P("name="+name);

		return new Description(name, annotations);

		}finally{//我加上的
		DEBUG.P(0,Description.class,"createSuiteDescription(2)");
		}
	}
	...
	public static Description createSuiteDescription(Class<?> testClass) {
		try {//我加上的
		DEBUG.P(Description.class,"createSuiteDescription(1)");
		DEBUG.P("testClass="+testClass);

		return new Description(testClass.getName(), testClass.getAnnotations());

		}finally{//我加上的
		DEBUG.P(0,Description.class,"createSuiteDescription(1)");
		}
	}
	...
	private Description(final String displayName, Annotation... annotations) {
		DEBUG.P(this,"Description(2)");
		//DEBUG.e();
		DEBUG.P("displayName="+displayName);
		DEBUG.PA("annotations",annotations);

		fDisplayName= displayName;
		fAnnotations= annotations;

		DEBUG.P(0,this,"Description(2)");
	}
